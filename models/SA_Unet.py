...
class SAU(nn.Module):
    def __init__(self, img_ch=3, output_ch=3):
        ...
        model+=[nn.Conv2d(in_channels=img_ch,out_channels=64,kernel_size=4,stride=2, padding=1,bias=True)]
        ...
        model += [nn.LeakyReLU(0.2, True),
                  nn.Conv2d(in_channels=512, out_channels=1024, kernel_size=4, stride=2, padding=1, bias=True),
