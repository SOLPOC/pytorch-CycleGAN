...
python -m pytorch_fid v_fake p_real  --device cuda:0
python -m pytorch_fid v_fake v_real  --device cuda:0
python -m pytorch_fid p_fake p_real  --device cuda:0
python -m pytorch_fid p_fake v_real  --device cuda:0
