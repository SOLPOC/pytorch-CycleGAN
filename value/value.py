...
if __name__ == "__main__":
    ...
    # value("painting_resnet_b2a", "vangogh2photo", transform=True)
    # value("painting_unet_b2a", "vangogh2photo", transform=True)
    value("painting_unet_sp_b2a", "vangogh2photo", transform=True)
    # value("painting_saunet_b2a", "vangogh2photo", transform=True)
