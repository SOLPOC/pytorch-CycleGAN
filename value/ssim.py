...
#     res1=ssim(io.imread("v_fake.png"),Image.open( "p_real.png"))
#     res2=ssim(io.imread("v_fake.png"),Image.open( "v_real.jpg"))
#     res3 = ssim(io.imread("p_fake.png"), Image.open("v_real.jpg"))
#     res4 = ssim(io.imread("p_fake.png"), Image.open("p_real.png"))
#     print(res1)
#     print(res2)
#     print(res3)
#     print(res4)
...
def get_ssim(fake_folder, real_folder):
    # 获取文件夹中的图片文件列表
    ...
    for fake_file, real_file in zip(fake_files, real_files):
        ...
        ssim_score = calculate_ssim(fake_img, real_img)
        t_score+=ssim_score
        # 输出结果（这里可以根据需要保存到文件或进行其他处理）
        # print(f"For pair: {fake_file} and {real_file}, SSIM score is: {ssim_score}")
    return  t_score/ len(fake_files)

if __name__ == '__main__':
    # 处理每组图片对，计算 SSIM
    ssim=get_ssim("../results/painting_resnet_a2b/test_latest/images/B_fake",
                        "../results/painting_resnet_a2b/test_latest/images/B_real")
    print(ssim)